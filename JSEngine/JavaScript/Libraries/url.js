/**
 * Copyright 2012 Tracy E (github: https://github.com/tracy-e )
 *
 */
...
(function(){
    if (typeof String.prototype.toURL !== 'function') {
    	...
    	JSURL.thisURL = function () {
            try{
            	return new JSURL(window.location.href);
            } catch(e){
                //without BOM
            	return null;
            }
    	...
    	JSURL.prototype.set = function (url) {
    	    var p;
    	...
    	JSURL.prototype.removeArg = function (k) {
    	...
    	JSURL.prototype.addArg = function (k, v, o) {
    	    if (k && String(k.constructor) == String(Array)) { // TODO: Change to use is_array
    	        var t = this.args;
    	        for (var i=0; i < k.length-1; i++) {
    	...
    	JSURL.prototype.parseURL = function (url) {
    	    var p = {}, m;
    	...
    	JSURL.prototype.parseArgs = function (s) {
    	    var a = {};
    	    if (s && s.length) {
    	        var kp, kv;
    	        var p;
    	...
    	JSURL.prototype.toArgs = function (a, p) {
    	...
    	JSURL.prototype.toAbsolute = function () {
    	    var s = '';
    	...
    	JSURL.prototype.toRelative = function () {
    	    var s = '';
    	...
    	JSURL.prototype.isHost = function () {
    	    var u = JSURL.thisURL();
            if (!u) return false;
